...
\begin{theorem}[Derivative and local maximum, minimum]
...
\begin{proof}
  We can prove this theorem by using the Weierstrass M-test.
  We can show that the sequence of derivative is uniformly convergent.
\end{proof}
