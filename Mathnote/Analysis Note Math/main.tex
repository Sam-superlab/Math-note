...
Just like we talked about in the part of continuous functions\ref{contfunc}. The expontial function can be defined in a series form. However this property is, somehow can be generalize. Which means every function(smooth function, differentiable thorugh out the domain) can be descibr into some infinty series.
